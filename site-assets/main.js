...
function _M0FP38zongen0116mgpic2026_2dsite4main10hero__text(locale) {
  return _M0FP38zongen0116mgpic2026_2dsite4main1t(locale, "MGPIC 2026 不只是一次比赛，而是一场围绕 GitHub 开源协作、工程化项目交付与长期生态沉淀展开的开发者动员计划。赛事将通过任务池、模板仓库、AI 启动支持与项目孵化机制，帮助更多开发者真正开始并持续参与 MoonBit 开源生态建设。", "MGPIC 2026 is not only a contest. It is an open-source mobilization program built around GitHub collaboration, engineering delivery, and long-term ecosystem growth. The event will use task pools, starter repositories, AI-assisted onboarding, and incubation mechanisms to help more developers begin and stay active in the MoonBit ecosystem.");
}
